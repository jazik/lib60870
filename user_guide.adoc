...
* CS 104 (IEC 60870-5-104) client and server UDP/IP communication
...
Alternatively a UDP/IP connection can be created by calling the _CS104_Connection_createUdp_ function of the CS104_Connection type:
