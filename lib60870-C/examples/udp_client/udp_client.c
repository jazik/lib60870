...
main(int argc, char** argv)
{
    ...
    CS104_Connection con = CS104_Connection_createUdp(ip, port);
    ...
    if (CS104_Connection_connect(con)) {
        ...
        CS104_Connection_sendInterrogationCommand(con, CS101_COT_ACTIVATION, originatorAddress, IEC60870_QOI_STATION);
